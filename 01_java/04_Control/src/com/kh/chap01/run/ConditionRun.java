...
public class ConditionRun {
	 ...
	 * 하지만 이 순차적인 흐름을 바꾸고자할 때 "제어문" 이라는 걸 통해서 직접 흐름을 제어 가능
	 * 
	 ...
	 * 
	 * [ 종류 ]
	 * 조건문은 크게 if문 계열과 switch 문으로 나뉜다.
	 * 1. if문 계열
	 * - 단독 if문 : 표현하고자 하는 경우의수가 한개일 경우
	 * - if-else문 : 표현하고자 하는 경우의수가 두개일 경우
	 * - if-else if문 : 표현하고자 하는 경우의수가 세개 이상일 경우
